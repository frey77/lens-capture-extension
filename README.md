...
![截图后一步直达 AI](assets/screenshots/workflow-ai.png)

![一张截图直达多个平台](assets/screenshots/multi-platform.png)

![省去保存上传，一步完成](assets/screenshots/one-step.png)

![右键识图与快捷键启动](assets/screenshots/context-menu-shortcut.png)
